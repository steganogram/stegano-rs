...
pub const DEMO_IMG_V2_TEXT_AND_DOCUMENT_WITHOUT_PASSWD_V2_1_1_9: &str =
    "../resources/demo-secrets/message-version-2/text-and-one-document-without-passwd-v2.1.1.9.PNG";

pub const DEMO_IMG_TEXT_AND_DOCUMENT_WITHOUT_PASSWD_V2_2_5: &str =
    "../resources/demo-secrets/message-version-text-and-documents-with-length-header/text-and-one-document-without-passwd-v2.2.5.PNG";
